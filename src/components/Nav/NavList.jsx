...
export default function NavList() {
  ...
  return (
    <nav className="w-1/2  h-3/5 mt-4  ml-auto flex flex-col items-center justify-between md:w-[unset] md:flex-row md:mt-0 md:h-full md:mx-auto md:max-w-[70%]  lg:max-w-desktop">
      <motion.h1
